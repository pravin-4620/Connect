...
const StudentDashboard = () => {
  ...
  // Sidebar
  const Sidebar = () => (
    <div className="bg-gray-900 text-white w-64 min-h-screen border-r border-gray-800 flex flex-col justify-between">
      <div>
          ...
          <div className="text-right">
            ...
            <div className="flex items-center mt-1">
              <div className="w-20 h-2 bg-gray-700 rounded-full mr-2">
                <div className="bg-cyan-400 h-2 rounded-full" style={{ width: `${studentProfile.profileComplete}%` }}></div>
              </div>
  ...
  // ...other pages (ApplicationsPage, InterviewsPage, ProfilePage) would be similarly structured...
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      // Add other cases for applications, interviews, profile, etc.
      default:
        return (
